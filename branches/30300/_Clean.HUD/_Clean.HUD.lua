--[[****************************************************************************
  ...
  * Clean.HUD.lua - Displays a table with health and mana values of the        *
...
local L = _CleanLocalization.HUD;
local _Clean = _Clean;
...
--[[****************************************************************************
  * Function: _Clean.HUD.UnitUpdateName                                        *
...
do
	...
	function me.UnitUpdateName ( UnitID )
		if ( UnitID ~= "player" ) then -- Never display the player's name
			...
			Field:SetTextColor( unpack( UnitIsPlayer( UnitID ) and _Clean.Colors.class[ select( 2, UnitClass( UnitID ) ) ] or _Clean.Colors.Highlight ) );
		end
	end
end
--[[****************************************************************************
  * Function: _Clean.HUD.UnitUpdateHealth                                      *
...
--[[****************************************************************************
  * Function: _Clean.HUD.UnitUpdatePower                                       *
		...
		if ( Force or Field.Value ~= Value ) then
			...
			elseif ( Value == 100 ) then
				...
				if ( not R ) then -- Power type doesn't have a custom color
					R, G, B = unpack( _Clean.Colors.power[ PowerType ] or _Clean.Colors.power[ "MANA" ] );
				end
				Value = Value / 100;
				Color2 = 0.5 * ( 1 - Value );
...
--[[****************************************************************************
  * Function: _Clean.HUD.UnitUpdateCondition                                   *
...
--[[****************************************************************************
  * Function: _Clean.HUD.UnitUpdate                                            *
...
--[[****************************************************************************
  * Function: _Clean.HUD:UnitOnShow                                            *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD:UnitOnHide                                            *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD:UnitOnUpdate                                          *
  ****************************************************************************]]
do
	local UnitID;
...
--[[****************************************************************************
  * Function: _Clean.HUD:UNIT_NAME_UPDATE                                      *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD:UNIT_HEALTH                                           *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD:UNIT_MAXHEALTH                                        *
  ****************************************************************************]]
me.UNIT_MAXHEALTH = me.UNIT_HEALTH;
--[[****************************************************************************
  * Function: _Clean.HUD:UNIT_AURA                                             *
  ****************************************************************************]]
me.UNIT_AURA = me.UNIT_HEALTH;


--[[****************************************************************************
  * Function: _Clean.HUD:UNIT_PET                                              *
...
--[[****************************************************************************
  * Function: _Clean.HUD:PLAYER_TARGET_CHANGED                                 *
  ****************************************************************************]]
function me:PLAYER_TARGET_CHANGED ()
	me.UnitUpdate( "target" );
end
--[[****************************************************************************
  * Function: _Clean.HUD:PLAYER_FOCUS_CHANGED                                  *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD:PLAYER_ENTERING_WORLD                                 *
...
--[[****************************************************************************
  * Function: _Clean.HUD.RequestColumnAutosize                                 *

--[[****************************************************************************
  * _Clean.Font by Saiket                                                      *
  * _Clean.Font.lua - Modifies some of the default fonts.                      *
  ****************************************************************************]]
...
me.Monospace = CreateFont( "_CleanMonospace" );
me.MonospaceNumber = CreateFont( "_CleanMonospaceNumber" );

local DejaVuSansMono = [[Interface\AddOns\_Clean.Font\Skin\DejaVuSansMono.ttf]];
...
do
	...
	_Clean.RegisterAddOnInitializer( "Blizzard_MacroUI", function ()
	...
	local R, G, B = unpack( _Clean.Colors.Normal );

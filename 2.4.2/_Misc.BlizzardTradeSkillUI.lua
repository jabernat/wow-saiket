...
function me:ReagentOnClick ()
	if ( not IsModifierKeyDown() ) then
		...
		local ReagentName =
			GetTradeSkillReagentInfo( GetTradeSkillSelectionIndex(), self:GetID() );
...
--[[****************************************************************************
  * Function: _Misc.BlizzardTradeSkillUI.OnLoad                                *
...
do
	_Misc.RegisterAddOnInitializer( "Blizzard_TradeSkillUI", me.OnLoad );
end

--[[****************************************************************************
  ...
  * _Clean.HUD.Flags.lua - Text AFK/DND indicator for the player.              *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD.Flags:PLAYER_FLAGS_CHANGED                            *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.HUD.Flags:PLAYER_ENTERING_WORLD                           *
  ****************************************************************************]]
function me:PLAYER_ENTERING_WORLD ()
	self:Hide();
end
--[[****************************************************************************
  * Function: _Clean.HUD.Flags:OnUpdate                                        *
  ****************************************************************************]]

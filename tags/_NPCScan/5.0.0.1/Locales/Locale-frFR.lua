...
_NPCScan.L = setmetatable( {
	NPCs = setmetatable( {
		...
		[ 54324 ] = "Rampeflamme", -- Needs review
	...
	CACHED_LONG_FORMAT = "Les unités suivantes sont déjà dans le cache. Pensez à les enlever en utilisant le menu |cff808080“/npcscan”|r ou réinitialisez-les en effaçant votre cache : %s.", -- Needs review
	...
	CONFIG_ALERT = "Options d'alerte", -- Needs review
	CONFIG_ALERT_SOUND = "Fichier son d'alerte", -- Needs review
	...
	SEARCH_ADD = "+",
	SEARCH_ADD_DESC = "Ajoute un nouveau PNJ ou sauvegarde les changements appliqués à un pré-existant.", -- Needs review
	SEARCH_ADD_TAMABLE_FORMAT = "Note : |cff808080“%s”|r est domptable. S'il (elle) est vu(e) en tant que familier de chasseur, cela causera une fausse alerte.", -- Needs review
	...
	SEARCH_ID = "ID du PNJ :",
	SEARCH_ID_DESC = "L'identifiant du PNJ à rechercher. Cette valeur peut être trouvée sur des sites comme Wowhead.com.", -- Needs review
	SEARCH_MAP = "Zone :",
	SEARCH_NAME = "Nom :",
	SEARCH_NAME_DESC = "Un libellé pour le PNJ. Il ne doit pas forcément correspondre au nom exact du PNJ.",
	SEARCH_NPCS = "PNJs perso.", -- Needs review

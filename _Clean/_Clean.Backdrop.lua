...
local BorderSize = 4;
local BorderColor = _Clean.Colors.Foreground;
...
--[[****************************************************************************
  * Function: _Clean.Backdrop.BorderSet                                        *
...
--[[****************************************************************************
  * Function: _Clean.Backdrop.BorderBlend                                      *
  ...
  ****************************************************************************]]
	function me.BorderBlend ( Size, R, G, B, A )
		...
		if ( not R ) then
			R, G, B = unpack( _Clean.Colors.Foreground );
		end
		if ( not A ) then
			A = BorderAlpha;
		end
...
--[[****************************************************************************
  * Function: _Clean.Backdrop:OnUpdate                                         *
  ****************************************************************************]]
	local cos = math.cos;
	local Pi = math.pi;
...
--[[****************************************************************************
  * Function: _Clean.Backdrop.BorderAddStatus                                  *
...
--[[****************************************************************************
  * Function: _Clean.Backdrop.BorderRemoveStatus                               *

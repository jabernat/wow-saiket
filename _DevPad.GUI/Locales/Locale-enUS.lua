...
|cff808080(Right click to choose color)|r]=],
	...
	DELETE = [=[Delete this page or folder.
|cff808080(Hold shift to skip confirmation)|r]=],
	DELETE_CONFIRM_FORMAT = "Delete page or folder named |cff808080“%s”|r?",
	...
	LUA_TOGGLE = "Toggle Lua mode for this page.",
	RECEIVE_CONFIRM_SCRIPT_FORMAT = [=[%s has sent you a page called |cff808080“%s”|r.  Add it to your _|cffcccc88DevPad|r?
|cffff1111WARNING: Inspect all untrustworthy pages before you run them!|r]=],
...
|cff808080(Ctrl+Shift+Z)|r]=],
	SCRIPT_NEW = "Create a new page.",
	SCRIPT_AUTORUN_DESC = "Auto-run at startup.",
	SCRIPT_RUN = "Run this page.",
	SEARCH_DESC = [=[Search pages' text by Lua pattern.  Escape newlines and backslashes!
|cff808080(Hold shift for reverse)|r]=],
	SEND = [=[Send this page or folder to other _|cffcccc88DevPad|r users.

...
_NPCScan.L = setmetatable( {
	...
	CACHED_LONG_FORMAT = "Les unités suivantes sont déjà dans le cache. Pensez à les enlever en utilisant le menu |cff808080“/npcscan”|r ou réinitialiser-les en effaçant votre cache : %s.", -- Needs review

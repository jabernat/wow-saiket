--[[****************************************************************************
  ...
  * _Clean.Chat.lua - Chat Frame modifications.                                *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.Chat.FilterTimestamp                                      *
  ****************************************************************************]]
do
	local date = date;
...
--[[****************************************************************************
  * Function: _Clean.Chat:OnMouseWheel                                         *
  ****************************************************************************]]
function me:OnMouseWheel ( Delta )
	if ( IsModifiedClick( "_CLEAN_CHAT_SCROLLPAGE" ) ) then
		if ( Delta > 0 ) then
			self:PageUp();
		else
			self:PageDown();
		end
	elseif ( IsModifiedClick( "_CLEAN_CHAT_SCROLLALL" ) ) then
		if ( Delta > 0 ) then
			self:ScrollToTop();
		else
			self:ScrollToBottom();
...
--[[****************************************************************************
  * Function: _Clean.Chat.UpdateScrolling                                      *
...
--[[****************************************************************************
  * Function: _Clean.Chat.CameraMoveStart                                      *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.Chat.CameraMoveStop                                       *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: _Clean.Chat:MODIFIER_STATE_CHANGED                               *
...
--[[****************************************************************************
  * Function: _Clean.Chat:UPDATE_BINDINGS                                      *
  ****************************************************************************]]
me.UPDATE_BINDINGS = me.MODIFIER_STATE_CHANGED;
--[[****************************************************************************
  * Function: _Clean.Chat:PLAYER_LOGIN                                         *

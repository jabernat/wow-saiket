--[[****************************************************************************
  * _Clean by Saiket                                                           *
  * _Clean.ColorPicker.lua - Modifies the color picker frame.                  *
  ****************************************************************************]]


local _Clean = _Clean;
local me = CreateFrame( "EditBox", "_CleanColorPickerEditBox", ColorPickerFrame, "InputBoxTemplate" );
_Clean.ColorPicker = me;




--[[****************************************************************************
  * Function: _Clean.ColorPicker:OnTextChanged                                 *
...
--[[****************************************************************************
  * Function: _Clean.ColorPicker:OnColorSelect                                 *

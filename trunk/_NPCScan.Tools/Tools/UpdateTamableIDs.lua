...
assert( OutFile:write( "-- AUTOMATICALLY GENERATED BY <_NPCScan.Tools/Tools/UpdateTamableIDs.lua>!\n" ) );
assert( OutFile:write( "select( 2, ... ).TamableIDs = {\n" ) );

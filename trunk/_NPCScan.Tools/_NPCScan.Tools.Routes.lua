...
local NS, AddOnName, Tools = {}, ...;
Routes.plugins[ AddOnName ] = NS;




--- @return Data table populated with available data sources for MapName.
function NS.Summarize ( Data, MapName )
...
do
	...
	function NS.AppendNodes ( Nodes, MapName, NodeType, NpcID )
...
function NS.AddCallbacks ()
end
--- Called when module is disabled.
function NS.RemoveCallbacks ()
end

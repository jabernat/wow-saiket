...
_NPCScan.L = setmetatable( {
	...
	CACHED_NAME_FORMAT = "|cff808080“%s”|r",
	CACHED_SEPARATOR = ", ",
	...
	FOUND_TAMABLE_RESTING_FORMAT = "|cffff2020Fausse alerte :|r Monstre domptable |cff808080“%s”|r trouvé en étant en repos ; probablement un familier.",

...
do
	...
	local Ellipsis = RED_FONT_COLOR_CODE.."\226\128\166|r";
	local Title = "_|cffcccc88Dev|r";
	...
	_DevLocalization = setmetatable( {
		...
		-- Output formats
		DUMP_TYPE_FORMATS = {
			[ "string" ] = "|cffcccccc"..LDQuo.."%s".."|cffcccccc"..RDQuo.."|r"; -- StringVar (Light gray)
			[ "other" ] = HIGHLIGHT_FONT_COLOR_CODE.."%s|r"; -- Var
			[ "table" ] = GREEN_FONT_COLOR_CODE.."<Table %s>|r"; -- TableCount
			[ "function" ] = "|cff33ccff<Function %s>|r"; -- FunctionCount (Teal)
			[ "userdata" ] = RED_FONT_COLOR_CODE.."<UserData %s>|r"; -- UserDataCount
			[ "thread" ] = RED_FONT_COLOR_CODE.."<Thread %s>|r"; -- ThreadCount
		};
		...
		OUTLINE_ADD_FORMAT = "[|cff%02x%02x%02x\226\150\136|r] Borders added to "..LDQuo..GREEN_FONT_COLOR_CODE.."%s|r"..RDQuo.."."; -- R, G, B, ObjectName
		OUTLINE_REMOVE_FORMAT = "Borders removed from "..LDQuo..GREEN_FONT_COLOR_CODE.."%s|r"..RDQuo.."."; -- ObjectName
		...
		FRAMES_UIOBJECT_FORMAT = GREEN_FONT_COLOR_CODE.."<%s %s"..GREEN_FONT_COLOR_CODE..">|r"; -- UIObjectType, UIObjectName
		...
		OPTIONS = setmetatable( {
			...
			DUMP = "Dump "..GRAY_FONT_COLOR_CODE.."("..LDQuo.."/dump"..RDQuo..")|r";
			...
			OUTLINE = "Outline "..GRAY_FONT_COLOR_CODE.."("..LDQuo.."/outline"..RDQuo..")|r";

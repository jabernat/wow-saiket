...
Overlay.L = setmetatable( {
	NPCs = setmetatable( {
		...
		[ 38453 ] = "大角",
		[ 49822 ] = "翡翠牙",
		[ 49913 ] = "女神菈菈", -- Needs review
		[ 50005 ] = "波賽達斯", -- Needs review
		[ 50009 ] = "莫比斯",
		[ 50050 ] = "肖克·薩菈克",
		[ 50051 ] = "鬼蟹",
		[ 50052 ] = "伯吉·黑心",
	...
	MODULE_WORLDMAP_TOGGLE = "NPCs", -- Needs review
	MODULE_WORLDMAP_TOGGLE_DESC = "如果開啟，顯示_|cffCCCC88NPCScan|r.Overlay已知怪物路徑的路徑圖。", -- Needs review
}, { __index = Overlay.L; } );